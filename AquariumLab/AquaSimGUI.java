...
public class AquaSimGUI extends DisplayPanel
{
    ...
    private static final int VIEW_TIME = 75;  // allow viewer to see display
    private static final int WAIT_TIME = 75;   // between Start button checks
                      ...
                      boolean useSimulationObj)
    {
        ...
        if ( useSimulationObj )
        {
            ...
            simulation = new Simulation (aqua, this);
