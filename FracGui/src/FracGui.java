...
public class FracGui extends GBFrame 
{
	   ...
	   //	private DoubleField answerField; 
	 	...
	 	private TextArea outputArea;
	   	...
	   	public FracGui( )
	   	{
	   		firstLabel = addLabel("first numerator",1,1,1,1);
	   		secondLabel = addLabel("first denominator",3,1,1,1);
	   		firstLabel = addLabel("second numerator",1,3,1,1);
	   		secondLabel = addLabel("second denominator",3,3,1,1);
	   		...
	   		den1Field = addDoubleField(0,3,2,1,1);
	   		num2Field = addDoubleField(0,1,4,1,1);
	   		den2Field = addDoubleField(0,3,4,1,1);
